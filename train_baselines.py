...
def main():
    ...
    with meds_reader.SubjectDatabase(database_path, num_threads=num_threads) as database:
        for label_name in label_names:
            ...
            final_lightgbm_auroc = lightgbm_objective(lightgbm_study.best_trial, train_data=final_train_data, dev_data=held_out_data, num_trees = lightgbm_study.best_trial.user_attrs['num_trees'])
            print(label_name)
